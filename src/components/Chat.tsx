      ...
      {isOpen && (
        <div className="fixed bottom-24 right-6 w-96 h-[500px] bg-white dark:bg-gray-800 rounded-lg shadow-2xl flex flex-col z-50 border border-gray-200 dark:border-gray-700">
          ...
          <div className="px-4 py-3 bg-blue-600 text-white rounded-t-lg">
            <h3 className="font-semibold">Fantasy Football Assistant</h3>
            <p className="text-xs text-blue-100">Ask me anything about your league!</p>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            {messages.length === 0 && (
              <div className="text-gray-500 dark:text-gray-400 text-sm text-center mt-8">
                <p>Hey! I&apos;m your fantasy football assistant.</p>
                <p className="mt-2">Ask me about:</p>
                <ul className="mt-2 space-y-1">
                  <li>📊 League history & stats</li>
